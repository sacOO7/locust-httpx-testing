                ...
                while (
                        isinstance(
                            ...
                            (
                                    ...
                                    niquests.packages.urllib3.exceptions.ProtocolError,
                                    niquests.packages.urllib3.exceptions.MaxRetryError,
                                    niquests.packages.urllib3.exceptions.NewConnectionError,
                            ),
                        )
                        and e.__context__
